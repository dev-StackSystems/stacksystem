      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        {MODULOS_DISPONIVEIS.map((modulo) => {
          ...
          const DESC_MAP: Record<string, string> = {
            ...
            financeiro:             "Painel financeiro (visão geral)",
            financeiro_resumo:      "Análise do mês com IA",
            financeiro_lancamentos: "Receitas e despesas",
            financeiro_categorias:  "Plano de contas / categorias",
            financeiro_contas:      "Contas (caixa, banco, carteira)",
            financeiro_contatos:    "Clientes e fornecedores",
            financeiro_centros:     "Centros de custo",
            financeiro_orcamento:   "Metas e orçamento",
            financeiro_relatorios:  "DRE e fluxo de caixa",
            financeiro_conciliacao: "Conciliação / importação OFX",
            financeiro_aprovacoes:  "Alçadas de aprovação",
            financeiro_cobranca:    "Régua de cobrança / vencidos",
