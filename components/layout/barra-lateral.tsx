...
const SISTEMAS: SistemaNav[] = [
  ...
  },
  {
    ...
    itens: [
      ...
      { icone: Sparkles,       rotulo: "Análise do Mês",  href: "/painel/financeiro/resumo",        modulo: "financeiro_resumo" },
      { icone: ArrowRightLeft, rotulo: "Lançamentos",     href: "/painel/financeiro/lancamentos",   modulo: "financeiro_lancamentos" },
      { icone: Tags,           rotulo: "Categorias",      href: "/painel/financeiro/categorias",    modulo: "financeiro_categorias" },
      { icone: Landmark,       rotulo: "Contas",          href: "/painel/financeiro/contas",        modulo: "financeiro_contas" },
      { icone: Contact,        rotulo: "Contatos",        href: "/painel/financeiro/contatos",      modulo: "financeiro_contatos" },
      { icone: Target,         rotulo: "Centros de Custo", href: "/painel/financeiro/centros-custo", modulo: "financeiro_centros" },
      { icone: PiggyBank,      rotulo: "Orçamento",       href: "/painel/financeiro/orcamento",     modulo: "financeiro_orcamento" },
      { icone: FileBarChart,   rotulo: "Relatórios",      href: "/painel/financeiro/relatorios",    modulo: "financeiro_relatorios" },
      { icone: RefreshCw,      rotulo: "Conciliação",     href: "/painel/financeiro/conciliacao",   modulo: "financeiro_conciliacao" },
      { icone: ClipboardCheck, rotulo: "Aprovações",      href: "/painel/financeiro/aprovacoes",    modulo: "financeiro_aprovacoes" },
      { icone: BellRing,       rotulo: "Cobrança",        href: "/painel/financeiro/cobranca",      modulo: "financeiro_cobranca" },
    ],
  },
]
