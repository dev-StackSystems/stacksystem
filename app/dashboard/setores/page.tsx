...
import { SetorTable } from "@/frontend/tables/setor-data-table"
import { SetorFormModal } from "@/frontend/modals/setor-form-modal"
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400 mt-0.5">Departamentos e seus módulos de acesso</p>
          </div>
        </div>
        {canManage && (
          <SetorFormModal
