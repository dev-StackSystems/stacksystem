...
import { MatriculaFormModal, MatriculaData } from "@/componentes/formularios/form-matricula"
              ...
              return (
                <tr key={m.id} className="hover:bg-slate-50/50 transition-colors">
                  ...
                  <td className="px-6 py-4 hidden md:table-cell">
                    <div>
                      <div className="font-medium text-slate-700">{m.curso?.nome ?? "—"}</div>
                      <div className="text-xs text-slate-400">{m.curso?.empresa?.nome ?? ""}</div>
                    </div>
                  </td>
